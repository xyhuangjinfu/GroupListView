...
public class ShowNo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groupListView.setGroupDataAdapter(new GroupListView.GroupDataAdapter() {
            ...
            public View getGroupView(int group, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = new ImageView(ShowNo.this);
                }
            ...
            public View getDataView(int group, int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = new TextView(ShowNo.this);
                }
        ...
        groupListView.setOnGroupAndDataClickListener(new GroupListView.OnGroupAndDataClickListener() {
            ...
            public void onGroupClick(int group) {
                Toast.makeText(ShowNo.this, "group : " + group, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onDataClick(int group, int position) {
                Toast.makeText(ShowNo.this, "data : " + group + " , " + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
